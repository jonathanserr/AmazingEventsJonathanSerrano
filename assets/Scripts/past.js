...
function pastEvents() {
  ...
  let filterEvents = data.events.filter(event => {
    let pastEvent = new Date(event.date) < new Date(data.currentDate);
    ...
    return matchSearches && matchCategories && pastEvent;
  });
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  document.getElementById('searchButton').addEventListener('click', pastEvents);
  ...
  checkboxContainer.addEventListener('change', pastEvents);
});
